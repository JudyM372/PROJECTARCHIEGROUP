...
class MainActivity : AppCompatActivity(), MediaPlayer.OnPreparedListener, SurfaceHolder.Callback {
  ...
  //  var _mediaPlayer: MediaPlayer? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recRtsp = txtRecRtsp
        recRtsp.text = intent.getStringExtra("MESSAGE")
    ...
    override fun surfaceCreated(sh: SurfaceHolder) {
        ...
        val RTSP_URL = txtRecRtsp.toString()
        //val RTSP_URL = "rtsp://wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mov"
